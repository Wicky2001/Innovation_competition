...
question_answer_list_with_marks = model.give_marks_for_descriptive_questions(question_answer_list)
question_answer_list_with_marks_feedbacks = model.give_feed_back_for_answers(question_answer_list_with_marks)
create_pdf_report(question_answer_list_with_marks_feedbacks,"./reports")
