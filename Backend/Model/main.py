...
from .models import give_marks_for_descriptive_answers, give_feed_back_for_answers
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        # chatDirectoryPath = r'C:\Users\Wicky\Documents\GitHub\Innovation_competition\Backend\PDF\chat_1718948513306'
        # print("shape of sys.argv = ",sys.argv)
        chatDirectoryPath = sys.argv[1]
        chatDirectoryName = sys.argv[2]
        baseDirectoryForReports = r'C:\Users\Wicky\Documents\GitHub\Innovation_competition\Backend\REPORTS'
